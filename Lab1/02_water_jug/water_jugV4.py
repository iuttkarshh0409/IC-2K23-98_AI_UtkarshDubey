...
# V4: Keep track of states that have already been visited
...
while True:
    ...
    match user_choice:
        ...
        case 3:
            action = "Empty Jug 1"
            current_state = empty_jug1(current_state)

        case 4:
            action = "Empty Jug 2"
            current_state = empty_jug2(current_state)

        case 5:
            action = "Pour Jug 1 → Jug 2"
            current_state = pour_jug1_to_jug2(
                jug2_capacity,
                current_state
            )
        ...
        case 6:
            ...
            current_state = pour_jug2_to_jug1(
                jug1_capacity,
                current_state
            )
    ...
    # V4: Check whether the resultant state was already visited
    if current_state in visited_states:

        print("\nResultant state has already been visited.")
        print("Transition discarded.")
